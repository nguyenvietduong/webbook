...
$amount = $_SESSION['price'] * 1000;
// $orderId = $_SESSION['iddh'] ;
$orderId = rand(10000, 99999);
$redirectUrl = "http://localhost:3000/Web_Book_2023_du_an_1/web_ban_sach/index.php?act=thongbaodathang";
$ipnUrl = "http://localhost:3000/Web_Book_2023_du_an_1/web_ban_sach/index.php?act=thongbaodathang";
$extraData = "";
